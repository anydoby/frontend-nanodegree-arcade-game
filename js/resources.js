...
(function() {
  ...
  /*
   * This is our private image loader function, it is called by the public image
   * loader function.
   */
  function _load(url) {
  ...
  /*
   * This is used by developer's to grab references to images they know have
   ...
   * loading have in fact been completed loaded.
   */
  function isReady() {
    var ready = true;
